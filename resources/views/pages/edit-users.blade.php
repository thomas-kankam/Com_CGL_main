                            ...
                            <form class="validate-form p-l-5 p-r-5" autocomplete="on" method="POST"
                                ...
                                <div class="wrap-input100 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="exampleFormControlInput1"
                                        placeholder="Enter username here" name="name" value="{{ $user->name }}"
                                        autocomplete="username" autofocus required />
                                </div>
                                <div class="wrap-input100 mb-3">
                                    <label for="exampleFormControlInput1" class="form-label">Email</label>
                                    <input type="email" class="form-control" id="exampleFormControlInput1"
                                        placeholder="Enter email here" name="email" value="{{ $user->email }}" required
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="col-sm-12 border-bottom">
                                        <select class="form-select shadow-none p-0 border-0" name="role" id="role"
                                            aria-label="Role" value="{{ $user->role }}">
